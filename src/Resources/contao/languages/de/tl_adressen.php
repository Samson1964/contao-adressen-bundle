...
$GLOBALS['TL_LANG']['tl_adressen']['iban'] = array('IBAN', 'IBAN');
$GLOBALS['TL_LANG']['tl_adressen']['bic'] = array('BIC', 'BIC');

$GLOBALS['TL_LANG']['tl_adressen']['web_legende'] = 'Homepage und soziale Netzwerke';
$GLOBALS['TL_LANG']['tl_adressen']['homepage'] = array('Homepage', 'Geben Sie hier die URL der Internet-Homepage ein.');
$GLOBALS['TL_LANG']['tl_adressen']['facebook'] = array('Facebook', 'Geben Sie hier den Facebook-Nutzernamen ein.');
$GLOBALS['TL_LANG']['tl_adressen']['twitter'] = array('Twitter', 'Geben Sie hier den Twitter-Benutzernamen ein.');
$GLOBALS['TL_LANG']['tl_adressen']['instagram'] = array('Instagram', 'Geben Sie hier den Instagram-Benutzernamen ein.');
$GLOBALS['TL_LANG']['tl_adressen']['skype'] = array('Skype', 'Geben Sie hier den Skype-Benutzernamen ein.');
$GLOBALS['TL_LANG']['tl_adressen']['whatsapp'] = array('WhatsApp', 'Geben Sie hier die WhatsApp-Telefonnummer ein.');
$GLOBALS['TL_LANG']['tl_adressen']['threema'] = array('Threema', 'Geben Sie hier die Threema-ID ein.');
$GLOBALS['TL_LANG']['tl_adressen']['telegram'] = array('Telegram', 'Geben Sie hier die Telegram-Benutzernamen ein.');
$GLOBALS['TL_LANG']['tl_adressen']['irc'] = array('IRC', 'Geben Sie hier die IRC-ID ein.');

$GLOBALS['TL_LANG']['tl_adressen']['image_legend'] = 'Foto';
$GLOBALS['TL_LANG']['tl_adressen']['singleSRC'] = array('Datei', 'Bitte wählen Sie eine Datei aus dem Dateisystem.');

$GLOBALS['TL_LANG']['tl_adressen']['text_legende'] = 'Visitenkarte';
$GLOBALS['TL_LANG']['tl_adressen']['text'] = array('Visitenkarte', 'Geben Sie hier weitere öffentliche Informationen zur Adresse ein.');

$GLOBALS['TL_LANG']['tl_adressen']['info_legende'] = 'Bemerkungen/Hinweise';
$GLOBALS['TL_LANG']['tl_adressen']['info'] = array('Bemerkungen', 'Geben Sie hier interne Bemerkungen zur Adresse ein.');
$GLOBALS['TL_LANG']['tl_adressen']['links'] = array('Verlinkungen', 'Die Adresse ist in den hier genannten Seiten eingetragen. Diese Übersicht wird einmal nachts aktualisiert.');
$GLOBALS['TL_LANG']['tl_adressen']['source'] = array('Quelle', 'Ursprüngliche Quelle der Daten');
...
$GLOBALS['TL_LANG']['tl_adressen']['import'] = array('CSV-Import', 'Daten aus einer CSV-Datei importieren');
$GLOBALS['TL_LANG']['tl_adressen']['export'] = array('CSV-Export', 'Daten als CSV-Datei exportieren');
$GLOBALS['TL_LANG']['tl_adressen']['new'] = array('Neue Adresse', 'Neue Adresse anlegen');
